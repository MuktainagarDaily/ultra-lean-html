...
Clicking **"Merge →"** on "Near Parivartan chowk" pre-fills the rename input with "Near Parivartan Chowk, परिवर्तन चौकाजवळ" (the bilingual/higher-count one). Admin clicks Save — done. All shops in the discarded area are now under the canonical name.Make sure app remain smooth